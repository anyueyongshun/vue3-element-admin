<template>
  <el-dialog v-model="dialogShow" width="400px" title="编辑角色">
    <el-form
      ref="dataFormRef"
      :model="formData"
      :rules="rules"
...
import { editRole, getDetail } from "@/api/auth/role";
import { RoleEditModel } from "@/api/auth/role/model";

const formData = reactive<RoleEditModel>({});
